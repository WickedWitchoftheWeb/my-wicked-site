...
export default function WickedGuidesLandingPage() {
  return (
    <>
      ...
      <SectionPage title="Wicked Tarot Spreads" subtitle="">
        {/* HERO IMAGE */}
        <section className="grimoire-hero">
          <img
            src="https://ik.imagekit.io/w1ck3d/shops/tarot-cover.png?updatedAt=1775170495699"
            alt="Wicked Guides"
        ...
        <section className="grimoire-single-column-links">
          <div>
            <Link href="/wicked-shops/wicked-tarot-spreads/law-of-attraction">
